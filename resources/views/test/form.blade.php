...
<html>
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      var apiKey = 'AIzaSyD9xob5sCFr3ftF5n2M7Q7SSLiJ9reCtHg';
      //var apiKey = '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';


      // Enter the API Discovery Docs that describes the APIs you want to
      // access. In this example, we are accessing the People API, so we load
      // Discovery Doc found here: https://developers.google.com/people/api/rest/
      //var discoveryDocs = ["https://forms.googleapis.com/$discovery/rest?version=v1"];
      ...
      var clientId = '363141720512-9hhorfordmbib5ev9bdq3q7i110qmooj.apps.googleusercontent.com';
